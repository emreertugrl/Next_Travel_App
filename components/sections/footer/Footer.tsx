...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-black text-white">
      ...
      <div className="container mx-auto relative pt-56 pb-16  px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-8">
        <div className="lg:col-span-2 mt-16 ">
          <h3 className="text-2xl font-bold">Travel</h3>
          <p className="mt-4 text-sm">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ducimus consectetur omnis
            ullam iure tempore ab doloremque neque repellendus enim, dolore ratione error, corrupti
      ...
      <div className="container mx-auto py-4 text-center text-sm border-t border-gray-700">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div>
            <span className="text-orange-500">Designed</span> Emre Ertuğrul
          </div>
        </div>
      </div>
    </footer>
