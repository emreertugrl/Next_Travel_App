...
const MainSearch = () => {
  ...
  return (
    <div
      className="absolute z-50 left-1/2 transform -translate-x-1/2 top-[670px] md:top-[850px]
    lg:top-[400px] xl:top-[470px]  2xl:top-[570px] container px-8
    "
    >
      <div
        className="bg-white shadow-lg py-10 px-2 
      ...
      >
        ...
        <Button
          ...
          className="bg-orange-500 text-white hover:bg-orange-600 py-6 w-full lg:w-fit"
        >
          Find Now
        </Button>
      </div>
